    ...
    public partial class InitialCreate3 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    PirceEur = table.Column<double>(type: "float", nullable: false),
                    PriceHuf = table.Column<double>(type: "float", nullable: false),
                    ProductMeasureUnit = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PurchaseProduct", x => new { x.ProductId, x.PurchaseId });
                    table.ForeignKey(
